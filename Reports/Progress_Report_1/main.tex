...
% Briefly restate your project goal and describe the high-level design architecture.
% Mention key modules (e.g., ALU, Control Unit, Register File, Instruction Memory, Data Memory, etc.)
% Describe how these modules interact, and include a small block diagram if possible.
...
% Describe the main challenges faced so far.
% Example points:
% - Timing issues during synthesis
% - Difficulty in debugging control signals
% - Limited FPGA resources or slow simulation
% - Handling 64-bit data paths and sign extensions
% - Integration of FPU with integer core

% Also mention what you plan to address these challenges.
...
% Outline what remains to be done before final submission.
% Examples:
% - Complete multicycle control FSM implementation
% - Add FPU and verify with floating-point operations
% - Integrate UART and demonstrate terminal communication
% - Test with RISC-V assembly programs for correctness
