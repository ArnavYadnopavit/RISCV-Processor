...
create_clock -add -name sys_clk_pin -period 200.00 -waveform {0 100} [get_ports {clk}];
...
## LEDs
## Map lower PC bits to LEDs

set_property -dict { PACKAGE_PIN H5  IOSTANDARD LVCMOS33 } [get_ports { debug_pc[0] }];
set_property -dict { PACKAGE_PIN J5  IOSTANDARD LVCMOS33 } [get_ports { debug_pc[1] }];
set_property -dict { PACKAGE_PIN T9  IOSTANDARD LVCMOS33 } [get_ports { debug_pc[2] }];
set_property -dict { PACKAGE_PIN T10 IOSTANDARD LVCMOS33 } [get_ports { debug_pc[3] }];
